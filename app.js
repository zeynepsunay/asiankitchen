const menu = [
  ...
  function getButtons() {
      for (let i = 0; i< categories.length; i++ ) {
          let htmlCode = `<button value="${categories[i]}" class="btn btn-outline-dark btn-item">${categories[i]}</button>`;
          btnCont.innerHTML += htmlCode;
      }
  }
  ...
  function getMenu(category) {
      ...
      newMenu.forEach(element => {
          let htmlCode = `<div class="menu-items col-lg-6 col-sm-12">
